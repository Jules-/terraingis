...
public class ShpPoint extends ShpShape
{
    ...
    protected int sizeOfRecord()
    {
        ...
        return count * ShapeFile.SIZE_OF_DOUBLE;
    }
    ...
    {
        bb.putDouble(SHP_xyz[0]);
        bb.putDouble(SHP_xyz[1]);
        
        // if SHAPE-TYPE: 11
        if (shape_type.hasZvalues())
        {
            bb.putDouble(SHP_xyz[2]);
        }
        
        // if SHAPE-TYPE: 11 | 21
        if (shape_type.hasMvalues())
        {
            bb.putDouble(SHP_m_value);
        }
    }
    ...
    public void loadFromJTS(Geometry geom)
    {
        ...
        SHP_xyz = new double[countDimensions];
